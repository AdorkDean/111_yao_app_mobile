 ...
 *
 */
public class GetIfMemberFavoriteProductService extends BaseURIService {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(StringUtils.hasText(sessionid)){
			...
			try {
				...
				if(0<userId){
					String brandId = request.getParameter("proId");//商品
					...
					example.createCriteria().andRelevanceIdEqualTo(Long.parseLong(brandId)).andMemberIdEqualTo(userId).andCollectTypeEqualTo(0);
