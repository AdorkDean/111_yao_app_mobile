 ...
 *
 */
public class FindPwdService extends BaseURIService {
		...
		if(null != mobile && !("").equals(mobile)){
			...
			try {
				...
				if(null != list && list.size()==1){
					...
					_map.put("smsContent", "您的手机验证码是:"+code+"。要健康 要美丽 要时尚@111医药馆！");
...
//					 int i=SingletonClient.getClient().sendSMS(new String[] {mobile}, "您的手机验证码是:"+code+"。111医药馆,专做药品特卖的网站!","",5);//带扩展码
	...
	public static void main(String[] args) {
		int i=SingletonClient.getClient().sendSMS(new String[] {"15210309149"}, "您的手机验证码是:123。111医药馆,专做药品特卖的网站!","",5);//带扩展码
