 ...
 *
 */
public class GetAllOrderService extends BaseURIService {
		...
		if(null != sessionId && !("").equals(sessionId)){
			...
			try {
				...
				if(null != userId && userId != -1){
					...
					pw = om.selectForPageByMap(map1, "t_order.selectAllOrderCount", "t_order.selectAllOrder", new Integer(pageNo),  new Integer(pageSize));
