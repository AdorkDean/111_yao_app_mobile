 ...
 *
 */
public class GetWaitPaymentService extends BaseURIService {

    private static final long serialVersionUID = 1210296114974362142L;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String pageSize = request.getParameter("pageSize");// ��ʾ����
        Map map = new HashMap();
