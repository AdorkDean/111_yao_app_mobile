 ...
 *
 */
public class CancelMemberFavoriteBrandService extends BaseURIService {
			...
			try {
				...
				if(0<userId){
					...
					if(null!=brandId&&!"".equals(brandId.trim())){
						bean.createCriteria().andRelevanceIdEqualTo(Long.parseLong(brandId.trim())).andMemberIdEqualTo(userId).andCollectTypeEqualTo(1);
					}
