 ...
 *
 */
public class GetMemberFavoriteBrandPageService extends BaseURIService {
		...
		if(StringUtils.hasText(sessionid)){
			...
			try {
				...
				if(0<userId){
					...
					pw = om.selectForPageByMap(map, "t_member_collect.selectMemberFavoriteBrandByPageCount", "t_member_collect.selectMemberFavoriteBrandByPage", rs.getP_curPage(), rs.getP_pageSize());
					map.clear();
